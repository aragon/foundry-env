...
export RPC_URL := $(call trim_quotes,$(RPC_URL))
export NETWORK_NAME := $(call trim_quotes,$(NETWORK_NAME))
...
export FORK_BLOCK_NUMBER := $(call trim_quotes,$(FORK_BLOCK_NUMBER))
...
export TOKEN_VOTING_PLUGIN_REPO_ADDRESS :=$(call trim_quotes,$(TOKEN_VOTING_PLUGIN_REPO_ADDRESS))
export MULTISIG_PLUGIN_REPO_ADDRESS :=$(call trim_quotes,$(MULTISIG_PLUGIN_REPO_ADDRESS))
export LOCK_TO_VOTE_PLUGIN_REPO_ADDRESS :=$(call trim_quotes,$(LOCK_TO_VOTE_PLUGIN_REPO_ADDRESS))
export ADMIN_PLUGIN_REPO_ADDRESS :=$(call trim_quotes,$(ADMIN_PLUGIN_REPO_ADDRESS))
export SPP_PLUGIN_REPO_ADDRESS :=$(call trim_quotes,$(SPP_PLUGIN_REPO_ADDRESS))
